			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    <div class='card-header'>
				        <h5>Inserisci dati per la registrazione</h5> 
				    </div>
				    <div class='card-body'>
							...
							<form method="post" action="${pageContext.request.contextPath }/ExecuteRegisterServlet" class="row g-3" novalidate="novalidate">
